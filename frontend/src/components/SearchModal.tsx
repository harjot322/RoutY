...
const useStyles = makeStyles((colors) => ({
  ...
  section: { fontSize: 12, fontWeight: "800", color: colors.muted, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 4 },
  result: {
    gap: 12,
    padding: 16,
    borderRadius: 18,
  ...
  tip: { textAlign: "center", color: colors.muted, fontSize: 13, fontWeight: "600" },
}));
