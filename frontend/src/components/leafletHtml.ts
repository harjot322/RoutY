...
.bus{width:44px;height:44px;border-radius:12px;border:3px solid #fff;box-shadow:0 2px 6px rgba(0,0,0,.35);display:flex;flex-direction:column;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:11px;line-height:1;box-sizing:border-box}
.bus svg{width:16px;height:16px;margin-bottom:2px}
...
function busIcon(b){return L.divIcon({className:'',iconSize:[44,44],iconAnchor:[22,22],html:'<div class="bus'+(b.sos?' sos':'')+'" style="background:'+b.color+'">'+busSvg+'<span>'+b.label+'</span></div>'})}
